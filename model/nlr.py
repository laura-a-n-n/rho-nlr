...
class NeuralLumigraph:
    ...
    def unpack_and_trace(self, batch, 
        ...
        if training:
            ...
            l_m_masks = bg_batch[:, -3]
            l_m_start = bg_batch[:, -2]
            l_m_end = bg_batch[:, -1]
    ...
    def render(self, rendering_opt=None, v_img=None, batch_size=50000, 
        ...
        if compute_normal_img:
            ...
            if light_dir is not None:
                normal_img = squish(dot(normals, light_dir[tf.newaxis, :]))
            else:
                normal_img = squish(normals)
